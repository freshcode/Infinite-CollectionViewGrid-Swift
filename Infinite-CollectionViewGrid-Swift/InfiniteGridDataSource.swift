...
class InfiniteGridDataSource: NSObject, UICollectionViewDataSource {
    ...
    // arbitrary large number, increase if you use small tile sizes and some cells are not appearing when scrolling
    let pathsCacheSize: Int = 1024
    ...
    func assignPath(to coordinates: GridCoordinates)
        -> IndexPath {
